      ...
      <div className="px-4 py-6 animate-fade-in">
        ...
        <div className="bg-card rounded-2xl p-6 prayer-card-shadow animate-slide-up" style={{ animationDelay: "100ms" }}>
          <h2 className="text-xl font-display font-semibold text-foreground mb-4">
            RamzanOne - The Prayer Tracker
          </h2>
          
          <div className="space-y-4 text-foreground/85 leading-relaxed">
            <p>
              RamzanOne is your dedicated spiritual companion designed to help you make the most 
            ...
            <p>
              Our app is designed with love and care by a team of dedicated Muslims who understand 
              the challenges of maintaining spiritual routines in today's busy world. We believe 
              technology can be a powerful tool for spiritual growth when used mindfully.
            </p>
            
            <p>
              Whether you're trying to improve your prayer consistency, track your Kaza prayers, 
              or simply want a gentle reminder to stay connected with your faith, RamzanOne is 
